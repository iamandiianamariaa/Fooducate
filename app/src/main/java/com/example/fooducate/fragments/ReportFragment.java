...
import com.example.fooducate.fragments.NovascoreChartFragment;
import com.example.fooducate.fragments.NutrientsChartFragment;
import com.example.fooducate.fragments.NutriscoreChartFragment;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot: snapshot.getChildren()) {
                    ...
                    if (obj.getObject().getProduct().getNutriscore() != null) {
                        ...
                        if(numOfDays<=7) {
                            Integer score = nutriMap.get(obj.getObject().getProduct().getNutriscore().toLowerCase());
                            if (score == null)
                                nutriMap.put(obj.getObject().getProduct().getNutriscore().toLowerCase(), 1);
                            else
                                nutriMap.put(obj.getObject().getProduct().getNutriscore().toLowerCase(), ++score);
                        }
                }
